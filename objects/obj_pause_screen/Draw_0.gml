...
if paused == true
	{
		 ...
		 else
		{
			...
			draw_set_font(fnt_iconic_sm);
			draw_text_transformed_color(camera_get_view_width(view_camera[0]) / 2,camera_get_view_height(view_camera[0]) / 2 + 50, "Press 'P' to Resume", 2, 2, 0, c_yellow, c_yellow, c_yellow, c_yellow, 1);
