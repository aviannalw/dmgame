...
draw_sprite(inv[i].sprite, 0, camera_get_view_x(view_camera[0]) +_xx, camera_get_view_y(view_camera[0]) + _yy + _sep*i); //if you need to reference the struct in a different place, do obj.item_manager.global.item_list.rocket_piece.sprite
